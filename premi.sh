...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Sugeng rawuh wonten Joys VPN ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " Ampun Kesupen Dhahar Nggih"
echo -e "  Auther : ${green}Joys vpn® ${NC}${YELLOW}(${NC} ${green} Joys vpn Tunneling ${NC}${YELLOW})${NC}"
echo -e " © Ampun Kesupen Ngibadah${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
data_ip="https://raw.githubusercontent.com/rizaddin/Tikus/main/izin"
checking_sc() {
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/rizaddin/vip/main/izin | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/rizaddin/vip/main/izin | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/rizaddin/vip/main/izin | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/rizaddin/vip/main/"
...
function base_package() {
    clear
    ########
    print_install "Ngistall Packet sing Dibutuhake"
...
wget https://raw.githubusercontent.com/rizaddin/vip/main/limit/limit.sh && chmod +x limit.sh && ./limit.sh
